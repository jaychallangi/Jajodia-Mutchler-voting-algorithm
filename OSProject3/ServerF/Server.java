...
//Will be run on dc26 whose ip address is 10.176.69.57
public class Server {
    ...
    private int ru = 8;
    private String ds = "A";
    public final String fileString = "F wrote to file";
    ...
    public Server() {
        try {
            ...
            System.out.println("Server F Started");
            Socket AsServer;
            Socket AsClient;
