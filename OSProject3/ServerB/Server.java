...
public class Server {
    ...
    private final String[] transitions = { "ABCDEFGH", "ABCD", "BCD", "BCDEFG" };
    ...
    private int ru = 8;
    private String ds = "A";
    public final String fileString = "B wrote to file";
    ...
    public void WritetoFile() {
        try {
            if (merged && CorrectPartition()) {
                ...
                //System.out.println("Whole: "+messageToWrite);
                //System.out.flush();
                ...
                if (messageWaitList.size() > 0) {
                    ...
                    if (recievedVn > vn && CorrectPartition())// If the recieved version number is greater
                    {
                        ...
                        if (merged) {
                            xw.close();
                            xw=new FileOutputStream(x);
                            //System.out.println("Size Of Processed:"+ processed.length);
                            //System.out.flush();
