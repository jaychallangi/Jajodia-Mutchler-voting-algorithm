...
//Will be run on dc27 whose ip address is 10.176.69.58
public class Server {
    ...
    private int ru = 8;
    private String ds = "A";
    public final String fileString = "G wrote to file";
    ...
    public Server() {
        try {
            ...
            System.out.println("Server G Started");
            Socket AsServer;
            Socket AsClient;
